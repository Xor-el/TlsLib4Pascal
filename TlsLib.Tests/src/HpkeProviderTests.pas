...
type
  ...
  private
    ...
    function X25519Suite: IHpkeSuite;
...
begin
  // Suite returns a handle for a suite the provider can instantiate, nil otherwise -
  // so a nil is how an unusable suite (export-only, unknown KEM/KDF) is rejected: the
